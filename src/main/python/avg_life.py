...
def plot_avg_life_time_vs_N(base_dir):
    data_records = []
    ...
    plt.ylabel("Tiempo de vida promedio α", fontsize=20)
    ...
    results_dir = os.path.join(base_dir, "results_avg_life_vs_N")
    os.makedirs(results_dir, exist_ok=True)
    output_path = os.path.join(results_dir, "avg_life_vs_N.png")
    plt.savefig(output_path)

    print(f"Gráfico guardado en: {output_path}")

# Ejemplo de uso:
plot_avg_life_time_vs_N("results")
