...
def plot_extinction_time_vs_alpha(base_dir):
    ...
    plt.ylabel("Tiempo de extinción promedio (s)", fontsize=20)
    ...
    results_dir = os.path.join(base_dir, "results_extinction_vs_alpha")
    os.makedirs(results_dir, exist_ok=True)
    output_path = os.path.join(results_dir, "extinction_vs_alpha.png")
